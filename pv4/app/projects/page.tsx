...
export default function ProjectsPage() {
  const projects = [
    ...
    {
      title: "NexStep",
      description: "AI-powered career path recommendation engine using graph neural networks and job market data.",
    ...
    {
      title: "VitaSync",
      description: "Real-time health monitoring dashboard with WebSocket-based live data streaming.",
    ...
    {
      title: "RPS",
      description: "Rock-paper-scissors game with a twist.",
      tags: ["JavaScript"],
      link: "https://github.com",
      year: "2023",
    },
