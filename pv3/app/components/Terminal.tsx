  ...
  const commands: { [key: string]: () => void } = {
    ...
    about: () => {
      setHistory([
        ...
        `> ${input}`,
        "",
        "Hi! I'm Daniel, a 3rd year CS student at UBC.",
        "Currently self-studying neural networks... might score",
        "brownie points with sentient robots 🤖",
        "",
        "Role: Backend Engineer Intern @ Suogogo Technologies",
        "",
      ]);
    },
    contact: () => {
