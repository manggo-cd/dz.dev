export const projects = [
  ...
  //   name: "Portfolio v2",
  //   description:
  //     "A reflection of my current interest in graphic design with an updated tech stack. Powered by Next.js and Tailwind CSS.",
  //   link: "https://github.com/manggo-cd/dz.dev",
  //   year: "2025",
  // },
  // {
  //   name: "Course Insights",
  //   description: `A tool to help students decide on which course to pick next by giving them visual representations on historical statistics of each course at UBC. 
  //   Built for CPSC 310 with Express.js, shadcn, and Next.js.`,
  //   link: "https://github.com/manggo-cd/CourseInsights",
  //   year: "2025",
  // },
  // {
  //   name: "At Capacity",
  //   description: `A B2B SaaS proposed to local gyms and sports facilities to help their staff and 
  // customers overview facility capacity, court bookings, classes, and more. Our
  // submission to UBC BizTech's ProductX hackathon. The following link is to the company portal, which I was responsible for.`,
  //   link: "https://active-capacity.vercel.app/",
  //   year: "2025",
  // },
  // {
  //   name: "Melodify",
  //   description: `A modern day learning resource for aspiring 
  // music theory students. Built on React for
  // HelloHacks 2024`,
  //   link: "na",
  //   year: "2024",
  // },
  // {
  //   name: "Portfolio v1",
  //   description: `Basic website that I made with pure
  // HTML, CSS, and JavaScript. Also
  // had an art section! `,
  //   link: "https://github.com/manggo-cd/bliu217.github.io",
  //   year: "2024",
  // },
  // {
  //   name: "Palette",
  //   description: `Chrome extension to make creating
  // and persisting color palettes easier for
  // designers.`,
  //   link: "https://github.com/manggo-cd/palette",
  //   year: "2024",
  // },
  // {
  //   name: "Retail Tycoon",
  //   description: `Java simulation game to emulate the 
  // struggles of working at a retail job.`,
  //   link: "https://github.com/manggo-cd/Retail-Tycoon",
  //   year: "2024",
  // },
];
